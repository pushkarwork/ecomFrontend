...
const Invoice = () => {
    ...
    const { data, isLoading, error } = useGetOrderDetailQuery(params.id)
    const order = data?.order || {};
    const { shippingInfo, orderItems, paymentInfo, shippingAmount, user, taxAmount, totalAmount, orderStatus, itemsPrice } = order;
    console.log(order)
                ...
                <div id="order_invoice" className="p-3 border border-secondary">
                    <header className="clearfix">
                        ...
                        <div id="project">
                            ...
                            <div>
                                <span>ADDRESS</span> {shippingInfo.address},{shippingInfo.city},{shippingInfo.country},{shippingInfo.pinCode}
                            </div>
